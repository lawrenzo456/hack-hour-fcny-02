...
- Q3 is usually an implementation-heavy LeetCode Medium problem and
  from experience is usually a 2-D matrix problem that is very _bashing_-friendly. What this means is
...
- Q4 is a purely algorithmic LeetCode Medium problem – here you will
  ...
  questions will _not_ show up in Q4 (and this test).
...
_Note: this does not apply for India, where a significantly different [aptitude test](https://www.geeksforgeeks.org/goldman-sachs-engineering-campus-hiring-program-aptitude-test/) is used instead._
...
[^1]:
    In rare cases, they may be longer, or “take-home” styled in some
